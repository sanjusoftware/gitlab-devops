...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Manage your gitlab group and project settings as code as YAML files}
  spec.description   = %q{Manage your gitlab group and project settings as code as YAML files}
